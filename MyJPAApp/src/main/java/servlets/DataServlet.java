...
public class DataServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
           ...
           // dbl.insertBook("Snakes in Ganga", "Rajiv Malhotra", "Rupa", "A intellectual work");
           //dbl.updateBook(363, "Fishes in Ganga", "Rajiv Malhotra", "Rupa", "A intellectual work");
           // dbl.removeBook(363);
            Collection<BookMaster> books = dbl.getAllBooks();
            
            for(BookMaster book : books )
            {
                out.println("<br/><h3>Bookid = "+ book.getBookID() + " BookName : " + book.getBookName() );
            }
