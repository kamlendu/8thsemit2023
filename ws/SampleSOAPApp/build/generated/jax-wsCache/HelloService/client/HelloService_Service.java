 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://ws/", wsdlLocation = "http://localhost:8080/SampleSOAPApp/HelloService?WSDL")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/SampleSOAPApp/HelloService?WSDL");
    ...
    public HelloService getHelloServicePort() {
        return super.getPort(new QName("http://ws/", "HelloServicePort"), HelloService.class);
    }
    ...
    public HelloService getHelloServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws/", "HelloServicePort"), HelloService.class, features);
    }
