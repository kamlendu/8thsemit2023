 ...
 * @author root
 */
@WebServlet(name = "ReceiverServlet", urlPatterns = {"/ReceiverServlet"})
public class ReceiverServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		ConnectionFactory cf = (ConnectionFactory)jndiContext.lookup("jms/myqueueFactory");
		...
		//Queue resqueue = (Queue) jndiContext.lookup("jms/ictqueue");
		//QueueSender queueSender = session.createSender(resqueue);
		con.start();
		
		TextMessage msq = (TextMessage) queueReceiver.receive();
	
		out.println("msg in receiver from test queue " + msq.getText());
            }
            catch(Exception e)
            {
