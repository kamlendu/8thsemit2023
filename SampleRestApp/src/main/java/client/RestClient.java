...
public class RestClient {
    ...
    private static final String BASE_URI = "http://localhost:8080/SampleRestApp/resources";
    ...
    public String sayHelloToSomeOne(String sname) throws ClientErrorException {
        WebTarget resource = webTarget;
        resource = resource.path(java.text.MessageFormat.format("someone/{0}", new Object[]{sname}));
        return resource.request(javax.ws.rs.core.MediaType.TEXT_HTML).get(String.class);
    }
