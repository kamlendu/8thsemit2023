...
/**
 * Jersey REST client generated for REST resource:RestPublishResource
 * [publish]<br>
 * USAGE:
 * <pre>
...
public class PublishClient {
    ...
    public void createCustomer(String fname, String lname) throws ClientErrorException {
        webTarget.path(java.text.MessageFormat.format("cratecust/{0}/{1}", new Object[]{fname, lname})).request().post(null);
    }
    ...
    public <T> T getAddressesOfCustomer(Class<T> responseType, String cid) throws ClientErrorException {
        WebTarget resource = webTarget;
        resource = resource.path(java.text.MessageFormat.format("getaddressesofcust/{0}", new Object[]{cid}));
        return resource.request(javax.ws.rs.core.MediaType.APPLICATION_JSON).get(responseType);
    }
