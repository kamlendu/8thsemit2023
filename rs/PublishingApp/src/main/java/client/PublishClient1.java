 ...
 * USAGE:
 * <pre>
 *        PublishClient1 client = new PublishClient1();
...
public class PublishClient1 {
    ...
    public void createCustomer(String firstName, String lastName) throws ClientErrorException {
        webTarget.path(java.text.MessageFormat.format("addcust/{0}/{1}", new Object[]{firstName, lastName})).request().post(null);
    }
    ...
    public void updateCustomer(String cid, String firstName, String lastName) throws ClientErrorException {
        webTarget.path(java.text.MessageFormat.format("updatecust/{0}/{1}/{2}", new Object[]{cid, firstName, lastName})).request().put(null);
    }

    public void removeCustomer(String cid) throws ClientErrorException {
        webTarget.path(java.text.MessageFormat.format("deletecust/{0}", new Object[]{cid})).request().delete();
    }
