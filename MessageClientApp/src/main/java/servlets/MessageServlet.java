    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            try{
               ...
               TopicConnectionFactory cf1 = (TopicConnectionFactory) ic1.lookup("jms/ittopicFactory");
                TopicConnection tcon = cf1.createTopicConnection();
                TopicSession tsession = tcon.createTopicSession(true, 0);
               TopicPublisher mpublish = tsession.createPublisher(topic);
                TextMessage tm1 = tsession.createTextMessage(" I am a  Topic Message");
                mpublish.publish(tm1);
